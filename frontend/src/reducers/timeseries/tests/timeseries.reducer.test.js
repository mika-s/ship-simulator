...
it('should handle SIMULATE', () => {
  ...
  let newState = timeseriesReducer(initialState, { type: 'SIMULATE' }, time, model, sensors, referencesystems);
  ...
  newState = timeseriesReducer(newState, { type: 'SIMULATE' }, time, model, sensors, referencesystems);
